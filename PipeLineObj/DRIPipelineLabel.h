...
//-----------------------------------------------------------------------------
//----- DRIPipelineLabel.h : Declaration of the DRIPipelineLabel
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class DLLIMPEXP DRIPipelineLabel : public AcDbEntity {

public:
	ACRX_DECLARE_MEMBERS(DRIPipelineLabel) ;
...
#ifdef PIPELINEOBJ_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(DRIPipelineLabel)
#endif
