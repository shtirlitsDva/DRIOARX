...
//-----------------------------------------------------------------------------
//----- DRIPipelineSegment.h : Declaration of the DRIPipelineSegment
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class DLLIMPEXP DRIPipelineSegment : public AcDbObject
{

public:
	ACRX_DECLARE_MEMBERS(DRIPipelineSegment);
...
public:
	DRIPipelineSegment();
	virtual ~DRIPipelineSegment();

	double startDistance() const;
	Acad::ErrorStatus setStartDistance(const double distance);

	double endDistance() const;
	Acad::ErrorStatus setEndDistance(const double distance);
...
#ifdef PIPELINEOBJ_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(DRIPipelineSegment)
#endif
