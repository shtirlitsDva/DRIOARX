...
//-----------------------------------------------------------------------------
AcEdJig::DragStatus DRILineJig::startJig(AcDbLine* pEntity)
{
...
//AcGePoint3d DRILineJig::getFoundPoint()
//{
//	return AcGePoint3d(foundPoint);
//}

//-----------------------------------------------------------------------------
//- Input sampler
AcEdJig::DragStatus DRILineJig::sampler()
{
...
Adesk::Boolean DRILineJig::update()
{
...
AcDbEntity* DRILineJig::entity() const
{
...
AcDbDimDataPtrArray* DRILineJig::dimData(const double dimScale)
{
...
Acad::ErrorStatus DRILineJig::setDimValue(const AcDbDimData* pDimData, const double dimValue)
{
...
Adesk::Boolean DRILineJig::updateDimData()
{
...
AcEdJig::DragStatus DRILineJig::GetStartPoint()
{
	AcGePoint3d newPnt;
	//- Get the point 
...
AcEdJig::DragStatus DRILineJig::GetNextPoint()
{
